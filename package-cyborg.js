...
var packageName = 'bootswatch:cyborg';  // https://atmospherejs.com/bootswatch/cyborg
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Cyborg skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/cyborg/bootstrap.css', 'client');
});
