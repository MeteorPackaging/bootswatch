...
var packageName = 'bootswatch:simplex';  // https://atmospherejs.com/bootswatch/simplex
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Simplex skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/simplex/bootstrap.css', 'client');
});
