...
var packageName = 'bootswatch:cerulean';  // https://atmospherejs.com/bootswatch/cerulean
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Cerulean skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/cerulean/bootstrap.css', 'client');
});
