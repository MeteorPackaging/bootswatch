...
var packageName = 'bootswatch:paper';  // https://atmospherejs.com/bootswatch/paper
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Paper skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/paper/bootstrap.css', 'client');
});
