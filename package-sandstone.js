...
var packageName = 'bootswatch:sandstone';  // https://atmospherejs.com/bootswatch/sandstone
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Sandstone skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/sandstone/bootstrap.css', 'client');
});
