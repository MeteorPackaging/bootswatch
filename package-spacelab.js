...
var packageName = 'bootswatch:spacelab';  // https://atmospherejs.com/bootswatch/spacelab
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Spacelab skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/spacelab/bootstrap.css', 'client');
});
