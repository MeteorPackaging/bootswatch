...
var packageName = 'bootswatch:readable';  // https://atmospherejs.com/bootswatch/readable
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Readable skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    api.addFiles('bootswatch/readable/bootstrap.css', 'client');
});
