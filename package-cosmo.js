...
var packageName = 'bootswatch:cosmo';  // https://atmospherejs.com/bootswatch/cosmo
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Cosmo skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/cosmo/bootstrap.css', 'client');
});
