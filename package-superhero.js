...
var packageName = 'bootswatch:superhero';  // https://atmospherejs.com/bootswatch/superhero
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Superhero skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    api.addFiles('bootswatch/superhero/bootstrap.css', 'client');
});
