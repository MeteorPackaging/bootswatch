...
var packageName = 'bootswatch:slate';  // https://atmospherejs.com/bootswatch/slate
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Slate skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    api.addFiles('bootswatch/slate/bootstrap.css', 'client');
});
