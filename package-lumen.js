...
var packageName = 'bootswatch:lumen';  // https://atmospherejs.com/bootswatch/lumen
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Lumen skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/lumen/bootstrap.css', 'client');
});
