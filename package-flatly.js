...
var packageName = 'bootswatch:flatly';  // https://atmospherejs.com/bootswatch/flatly
...
Package.describe({
    name: packageName,
    summary: 'Bootswatch Flatly skin for Bootstrap',
    version: version,
...
Package.onUse(function (api) {
    ...
    api.addFiles('bootswatch/flatly/bootstrap.css', 'client');
});
